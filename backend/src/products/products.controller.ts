import { Body, Controller, Get, Post, Patch, Delete, Param, UploadedFiles, UseInterceptors } from '@nestjs/common';
...
export class ProductsController {
    ...
    async createProduct(@UploadedFiles() files: Express.Multer.File[], @Body() productData: CreateProductDto) {
